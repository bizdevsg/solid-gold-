...
export default function KalenderEkonomi() {
    ...
    const filteredData = data
        ...
        .filter((item) => {
            ...
            if (activeFilter === "Today") return itemDay.getTime() === today.getTime();
                        ...
                        <div className="border border-yellow-500 rounded-lg overflow-hidden">
                            <table className="min-w-full divide-y divide-yellow-500">
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {loading ? (
                                        <tr>
                                            <td colSpan={8} className="text-center py-4 text-neutral-100">
                                                Loading...
                                            </td>
                                        </tr>
                        ...
                        >
                            <div className="flex justify-between items-center">
                                <div className="flex flex-row items-center gap-1">
                                    <span className="text-sm text-neutral-100 font-medium">{formatDate(item.date)}</span>
                                    <span className="text-sm text-neutral-100 font-medium">-</span>
                                    <span className="text-sm text-neutral-100 font-medium">{item.time || "-"}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CountryFlag
                                        ...
                                        title={item.country || ""}
                                    />
                                    <span className="text-sm text-neutral-100">{item.country || "-"}</span>
                                </div>
                            </div>
